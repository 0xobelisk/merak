...
module merak::dex_tests {
    ...
    public fun init_test(): (Assets, SchemaHub, Dapps, Scenario) {
        ...
        (assets , schema_hub, dapps, scenario)
    }

    #[test]
    public fun check_max_number() {
        let (assets, schema_hub, dapps, scenario) = init_test();
    ...
    public fun create_pool() {
        let (mut assets, schema_hub, dapps, mut scenario) = init_test();
