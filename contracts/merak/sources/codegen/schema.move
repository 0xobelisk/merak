  ...
  public fun borrow_next_asset_id(self: &Schema): &StorageValue<u128> {
    storage::borrow_field(&self.id, b"next_asset_id")
  }

  public(package) fun next_asset_id(self: &mut Schema): &mut StorageValue<u128> {
    storage::borrow_mut_field(&mut self.id, b"next_asset_id")
  }

  public fun borrow_asset_metadata(self: &Schema): &StorageMap<u128, AssetMetadata> {
    storage::borrow_field(&self.id, b"asset_metadata")
  }

  public(package) fun asset_metadata(self: &mut Schema): &mut StorageMap<u128, AssetMetadata> {
    storage::borrow_mut_field(&mut self.id, b"asset_metadata")
  }

  public fun borrow_asset_details(self: &Schema): &StorageMap<u128, AssetDetails> {
    storage::borrow_field(&self.id, b"asset_details")
  }

  public(package) fun asset_details(self: &mut Schema): &mut StorageMap<u128, AssetDetails> {
    storage::borrow_mut_field(&mut self.id, b"asset_details")
  }

  public fun borrow_account(self: &Schema): &StorageDoubleMap<u128, address, Account> {
    storage::borrow_field(&self.id, b"account")
  }

  public(package) fun account(self: &mut Schema): &mut StorageDoubleMap<u128, address, Account> {
  ...
  public fun borrow_pools(self: &Schema): &StorageDoubleMap<u128, u128, Pool> {
    storage::borrow_field(&self.id, b"pools")
  }

  public(package) fun pools(self: &mut Schema): &mut StorageDoubleMap<u128, u128, Pool> {
    storage::borrow_mut_field(&mut self.id, b"pools")
  }

  public(package) fun create(ctx: &mut TxContext): Schema {
    let mut id = object::new(ctx);
    storage::add_field<StorageValue<u128>>(&mut id, b"next_asset_id", storage_value::new(b"next_asset_id", ctx));
    storage::add_field<StorageMap<u128, AssetMetadata>>(&mut id, b"asset_metadata", storage_map::new(b"asset_metadata", ctx));
    storage::add_field<StorageMap<u128, AssetDetails>>(&mut id, b"asset_details", storage_map::new(b"asset_details", ctx));
    storage::add_field<StorageDoubleMap<u128, address, Account>>(&mut id, b"account", storage_double_map::new(b"account", ctx));
    ...
    storage::add_field<StorageDoubleMap<u128, u128, Pool>>(&mut id, b"pools", storage_double_map::new(b"pools", ctx));
    Schema { id }
  }
  ...
  public fun get_next_asset_id(self: &Schema): &u128 {
    self.borrow_next_asset_id().get()
  }

  public fun get_asset_metadata(self: &Schema, key: u128): &AssetMetadata {
    self.borrow_asset_metadata().get(key)
  }

  public fun get_asset_details(self: &Schema, key: u128): &AssetDetails {
    self.borrow_asset_details().get(key)
  }

  public fun get_account(self: &Schema, key1: u128, key2: address): &Account {
  ...
  public fun get_pools(self: &Schema, key1: u128, key2: u128): &Pool {
