  ...
  public fun new(pool_address: address, lp_asset_id: u32): Pool {
    Pool {
                                   pool_address,lp_asset_id
                               }
  }

  public fun get(self: &Pool): (address,u32) {
  ...
  public(package) fun set(self: &mut Pool, pool_address: address, lp_asset_id: u32) {
    self.pool_address = pool_address;
    self.lp_asset_id = lp_asset_id;
  }
}
