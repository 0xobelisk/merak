...
import { Copy, LogOut, ArrowLeftRight, Wallet } from 'lucide-react';
    ...
    <DropdownMenu>
      ...
      >
        ...
        <div className="px-2 pb-2">
          ...
          <DropdownMenuItem
            className="flex items-center justify-center space-x-2 py-2.5 px-4 cursor-pointer rounded-md bg-white dark:bg-gray-800 hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600 dark:text-red-400 border border-red-200 dark:border-red-800 transition-colors"
